...
const [edit, setEdit] = useState(true)
  ...
  return (
   <>{(edit) ? ( <div className="h-full w-full flex flex-col gap-5 ">
   <div className="flex justify-between items-center ">
     <h2 className="text-xl font-bold">Edit Organizational Details </h2>
     <div className="flex gap-2 items-center">
       <Button className=" hover:bg-blue-50 rounded-md" onClick={()=>{setEdit(false)}}>Cancle</Button>
       <Button
         className="bg-blue-500 text-white flex gap-2 items-center rounded-md"
         onClick={() => {
     ...
     <div className="p-3 flex flex-col gap-4 w-[65%] min-h-full bg-white shadow-md">
       ...
       <form className="flex  flex-col gap-5">
         ...
         <div className="w-full flex justify-between gap-5">
           ...
           <select name="country" id="" className="w-[50%] p-2 bg-transparent placeholder:text-black border border-gray-400 outline-none" >
         ...
         <div className="w-full flex justify-between gap-5">
           ...
           <select name="city" id="" className="w-[50%] p-2 bg-transparent placeholder:text-black border border-gray-400 outline-none" >
             <option value="Hyderabad">Hyderabad</option>
           </select>
           <select name="state" id="" className="w-[50%] p-2 bg-transparent placeholder:text-black border border-gray-400 outline-none" >
