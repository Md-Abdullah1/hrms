...
const Orgdetails = () => {
  ...
  return (
    <>
    {(!edit) ?(<div className="flex gap-3 shadow-md relative">
      <Button className="bg-blue-500 text-white flex gap-2 items-center rounded-md absolute right-2 top-2" onClick={()=>{setEdit(true)}}>
